...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'src/app/(public)/lesson/**/page.ssr.test.tsx',
      'src/app/(public)/lab/**/page.ssr.test.tsx',
      'src/app/(public)/module/**/page.ssr.test.tsx',
      'src/app/(public)/module/**/progress.client.test.tsx',
      'src/app/api/**/*.test.ts',
